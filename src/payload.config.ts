...
export default buildConfig({
  ...
  csrf: ["http://localhost:5173", "http://localhost:3421", "https://api.hocecomv1.com", "https://istanbulfood.hocecomv1.com"],
  cors: ["http://localhost:5173", "http://localhost:3421", "https://api.hocecomv1.com", "https://istanbulfood.hocecomv1.com"],
  plugins: [
    cloudStorage({
      collections: {
        logos: {
