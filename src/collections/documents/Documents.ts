...
const Documents: CollectionConfig = {
  ...
  fields: [
    ...
    { name: "documentProducts", type: "relationship", hasMany: true, relationTo: "document-products", required: true },
    { name: "payments", type: "relationship", hasMany: true, relationTo: "payments" },
    { name: "supportTickets", type: "relationship", hasMany: true, relationTo: "support-tickets" },
    { name: "tasks", type: "relationship", hasMany: true, relationTo: "tasks" },
    { name: "toDocument", type: "relationship", hasMany: false, relationTo: "documents" },
    { name: "fromDocument", type: "relationship", hasMany: false, relationTo: "documents" },
    { name: "docAddress", type: "relationship", hasMany: false, relationTo: "addresses", required: true },
    { name: "delAddress", type: "relationship", hasMany: false, relationTo: "addresses", required: true },
